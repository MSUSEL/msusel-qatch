...
public class Main extends Application {
     ...
     */
    public void executeAnalysisScript(Vector<ProgressBar> progBars, Vector<ProgressIndicator> progIndicators, final TextArea console, final ProgressIndicator totalProgress) throws CloneNotSupportedException, InterruptedException {
