...
public class CharacteristicSelectionScreenController {
    ...
    private void initialize() {
        ...
        nameColumn.setCellValueFactory(
                new Callback<TableColumn.CellDataFeatures<CharacteristicFX, String>, ObservableValue<String>>() {
                    @Override
                    public ObservableValue<String> call(TableColumn.CellDataFeatures<CharacteristicFX, String> cellData) {
        ...
        charTable.getSelectionModel().selectedItemProperty().addListener(
                new ChangeListener<CharacteristicFX>() {
                    @Override
                    public void changed(ObservableValue<? extends CharacteristicFX> observable, CharacteristicFX oldValue, CharacteristicFX newValue) {
                        CharacteristicSelectionScreenController.this.showCharacteristicDetails(newValue);
                    }
                });
    }
