...
public class PropertySelectionScreenController {
    ...
    private void initialize() {
        ...
        nameColumn.setCellValueFactory(
                new Callback<TableColumn.CellDataFeatures<PropertyFX, String>, ObservableValue<String>>() {
                    @Override
                    public ObservableValue<String> call(TableColumn.CellDataFeatures<PropertyFX, String> cellData) {
        ...
        propertyTable.getSelectionModel().selectedItemProperty().addListener(
                new ChangeListener<PropertyFX>() {
                    @Override
                    public void changed(ObservableValue<? extends PropertyFX> observable, PropertyFX oldValue, PropertyFX newValue) {
                        PropertySelectionScreenController.this.showPropertyDetails(newValue);
                    }
                });
    }
